                ...
                <div className="row row--30">
                    <div className="col-lg-6">
                        <div className="mission-title">
                            ...
                            <p>To provide optimal investment returns to identify and invest in exceptional businesses and innovative ventures that have the potential to drive significant value creation.</p>
